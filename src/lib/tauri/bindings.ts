...
export const commands = {
	...
	fsWriteFile: (path: string, data: number[], mode: number | null, skipAssetEncryption: boolean | null) => typedError<null, AppError>(__TAURI_INVOKE("fs_write_file", { path, data, mode, skipAssetEncryption })),
	...
	assetCryptoMigrateDir: (encryptAtRest: boolean) => typedError<AssetMigrationResult, AppError>(__TAURI_INVOKE("asset_crypto_migrate_dir", { encryptAtRest })),
