...
declare module '@tiptap/core' {
  interface Commands<ReturnType> {
    highlight: {
      /**
       * Set a highlight mark with TailwindCSS color classes
       * @param attributes The highlight attributes
       * @example editor.commands.setHighlight({ color: 'bg-yellow-200' })
       */
      setHighlight: (attributes?: { color: string }) => ReturnType;
      /**
       * Toggle a highlight mark with TailwindCSS color classes
       * @param attributes The highlight attributes
       * @example editor.commands.toggleHighlight({ color: 'bg-yellow-200' })
       */
...
/**
 * This extension allows you to highlight text with TailwindCSS classes.
